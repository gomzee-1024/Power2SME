...
public class TermsAndConditionsFragment extends SuperFragment
{
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		((MyAccountApplication)baseActivity.getApplication()).getGAUtility().trackScreenView(baseActivity.getString(R.string.ga_screenname_TermsAndConditionsFragment));
	}

	@Override
	public int getScreenTitleResId() {
		return R.string.screen_title_terms_and_condition;
	}
...
//    	baseActivity.setDrawerMenuEnabled(false, R.drawable.p2s_logo, "Terms And Conditions");
...
//        baseActivity.setTitle(R.string.screen_title_terms_and_conditions);
        initUIComponents();
...
//                Toast.makeText(activity, description, Toast.LENGTH_SHORT).show();
		...
		webView .loadUrl(APIs.URL_TERMS_AND_CONDITION);
	}
}

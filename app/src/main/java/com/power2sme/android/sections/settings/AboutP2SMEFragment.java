...
public class AboutP2SMEFragment extends SuperFragment
{
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		((MyAccountApplication)baseActivity.getApplication()).getGAUtility().trackScreenView(baseActivity.getString(R.string.ga_screenname_AboutP2SMEFragment));
	}
...
//    	baseActivity.setDrawerMenuEnabled(false, R.drawable.p2s_logo, baseActivity.getString(R.string.screen_title_about_power2sme));
...
//                Toast.makeText(activity, description, Toast.LENGTH_SHORT).show();
		...
		webView .loadUrl(APIs.URL_ABOUT_US);
	}
}
